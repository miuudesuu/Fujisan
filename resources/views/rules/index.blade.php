...
<html lang="ja">
    ...
    <div class="toc-002">
        ...
        <p>
            ...
            　登山は汗をかく、暑いというイメージがありますが、ご来光を見る時間の朝と夕方から夜にかけては、冷え込みます。冬だと思って防寒性のある服を着用するべきです。<br>
            <strong>〇靴下の替え</strong><br>
            　山の天気は変わりやすく、雨が降る可能性もあるため、靴下の替えは必要です。<br>
            <strong>〇トレッキングシューズ</strong><br>
            　富士山は観光地といっても立派な山なので、岩場もあります。足をくじいたり、ひねったりする可能性もあるので、トレッキングシューズをおすすめします。<br>
                    </p>

        <h2 id="4"><strong>４．ルールやマナー</strong></h2>
        <p>
            <strong>！絶対に下に石を落とさないこと</strong><br>
                下には登山道や下山道があります。人に当たったら、命の危険にもなりかねません。絶対にやめましょう。<br>
                <br>
            <strong>！頂上でのドローン使用</strong><br>
                せっかくの頂上で、景色を上から撮りたいと考えてしまいますが、富士山でのドローン使用は禁止されています。荷物にもなるのでまず、持ってこないこと！<br>
                <br>
            ...
            <strong>！富士山をなめてはいけない</strong><br>
                最近は、観光地としても知られ、海外の人々も多く来ていますが、ご存じの通り、3000m以上ある山です。高山病はもちろん、命の危険も存在しています。事前の準備、対策、勉強をしてから富士登山に挑みましょう。<br>
        </p>
